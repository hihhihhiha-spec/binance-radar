...
def check_logic(symbol, tf):
    try:
        # جلب 6 شموع لفحص النمط المطلوب بدقة
        ...
        for i in range(len(bars) - 4):
            ...
            # 1. الشمعة الأولى والثانية: شمعتان نازلتان (حمراوان)، والثانية أكبر من الأولى ولها ذيل سفلي
            ...
            # 2. الشمعة الثالثة: خضراء ممتلئة وتأتي بالكامل (ذيول وأجسام) داخل حدود الشمعة الحمراء الثانية
            o3, h3, l3, cl3 = c3[1], c3[2], c3[3], c3[4]
            is_green_3 = cl3 > o3
            body3 = abs(o3 - cl3)
            is_green_full_3 = is_green_3 and (body3 > (h3 - l3) * 0.4) # ممتلئة وليست ديولاً فارغة
            is_c3_inside_c2 = (h3 <= h2 and l3 >= l2) # بالكامل داخل الحمراء الثانية
            
            # 3. الشمعة الرابعة: شمعة خضراء تكسر الشمعة الخضراء الأولى (الثالثة) صعوداً
            o4, h4, l4, cl4 = c4[1], c4[2], c4[3], c4[4]
            is_green_4 = cl4 > o4
            is_c4_break = is_green_4 and (cl4 > cl3 or h4 > h3)
            
            # 4. الشمعة الخامسة: شمعة حمراء ممتلئة تأتي بالكامل (ذيول وأجسام) داخل حدود الشمعة الخضراء الرابعة الكاسرة
            o5, h5, l5, cl5 = c5[1], c5[2], c5[3], c5[4]
            is_red_5 = cl5 < o5
            body5 = abs(o5 - cl5)
            is_red_full_5 = is_red_5 and (body5 > (h5 - l5) * 0.4) # ممتلئة وليست ديولاً فارغة
            is_c5_inside_c4 = (h5 <= h4 and l5 >= l4) # بالكامل داخل الخضراء الرابعة
            
            # التحقق من تطابق كل الشروط معاً
